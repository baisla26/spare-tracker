            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  ...
                  int num=Integer.parseInt(u);
                    String Data = "select * from circlereq where NSS='"+num+"'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ctg" placeholder="CTG No" value='<%=rs1.getString(13)%>' required readonly/>
                                    </div>
...
if(b!=null && c!=null && d!=null ){
    try{
        ...
        String query="INSERT INTO `finalapp`(`CTG`,`NSS`,`ApproverName`) values(?,?,?)";
        
        String queryp="DELETE FROM `circlereq` WHERE NSS ="+num+" ";
        ...
        ps3.executeUpdate();
        response.sendRedirect("circleapp.jsp");
    }catch(Exception ex){
